...
from cli.receipt.help import TRANSACTION_IDS_ARGUMENT_HELP_MESSAGE
...
@click.option('--ids', type=str, required=True, help=TRANSACTION_IDS_ARGUMENT_HELP_MESSAGE)
@click.option('--node-url', type=str, required=False, help=NODE_URL_ARGUMENT_HELP_MESSAGE, default=default_node_url())
@receipt_commands.command('get')
def get(ids, node_url):
    """
