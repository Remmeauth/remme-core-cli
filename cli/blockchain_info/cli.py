"""
Provide implementation of the command line interface's block info commands.
"""
import asyncio
import click
from aiohttp_json_rpc import RpcGenericServerDefinedError
from remme import Remme
from cli.blockchain_info.utils import (
    validate_ids,
    validate_limit,
    validate_head_sign,
    validate_id,
)
from cli.blockchain_info.service import Transactions
from cli.blockchain_info.help import (
...
@click.option('--identifier', required=True, type=str, help=LIST_TRANSACTIONS_IDS_HELP_MESSAGE)
@click.option('--node-url', type=str, help=NODE_URL_ARGUMENT_HELP_MESSAGE)
